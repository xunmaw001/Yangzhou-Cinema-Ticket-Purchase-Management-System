	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="片长" prop="pianzhang">
					<el-input v-model="ruleForm.pianzhang" placeholder="片长" clearable  :readonly="ro.pianzhang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="片长" prop="pianzhang">
					<el-input v-model="ruleForm.pianzhang" placeholder="片长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.dianyingyugao" label="电影预告" prop="dianyingyugao">
					<file-upload
						tip="点击上传电影预告"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="场次" prop="changci">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.changci" label="场次" prop="changci">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="电影简介" prop="dianyingjianjie">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.dianyingjianjie" label="电影简介" prop="dianyingjianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.dianyingjianjie}}</span>
				</el-form-item>
...
export default {
	...
	if(this.ruleForm.dianyingyugao!=null) {
		this.ruleForm.dianyingyugao = this.ruleForm.dianyingyugao.replace(new RegExp(this.$base.url,"g"),"");
	}
